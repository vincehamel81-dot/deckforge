    ...
    "paths": {
        ...
        "/auth/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "username (3–15 alphanumeric chars)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/games": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "WAITING or IN_PROGRESS",
                        "name": "status",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "games array with playerCount and dealerUsername",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/games/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "game + totalCards + remainingCards + dealerUsername",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.dealRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "totalDealt + gameEnded",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/games/{id}/players": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "leaderboard array [{playerId, userId, username, seatOrder, handValue, cardCount}]",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "already in a game, game full, etc.",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/games/{id}/players/{pid}/deal": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "dealtCount + gameEnded",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/games/{id}/shoe/cards": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "cards array [{suit, value, count}]",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/games/{id}/shoe/decks": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "deck id from POST /decks",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.addDeckRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "deckCount + totalCards + remainingCards",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/games/{id}/shoe/suits": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "suits array [{suit, count}]",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/games/{id}/start": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "optional initial deal count per player",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/handlers.startGameRequest"
                        }
                    }
                ],
                "responses": {
