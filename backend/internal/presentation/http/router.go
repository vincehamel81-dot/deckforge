...
import (
	...
	"github.com/vincehamel81-dot/deckforge/docs"
...
func NewRouter(
	...
	// Derive host from the incoming request so Swagger UI sends requests to the
	// correct server in every environment (local, Railway, etc.) without env vars.
